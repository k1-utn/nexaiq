...
This repository contains the sealed Stage 1 foundation, sealed Stage 2 estimate-ingestion and human-verification workflow, sealed Stage 3 mobile evidence-capture workflow, sealed Stage 4 supplement-analysis workflow, and sealed Stage 5 supplement-review workspace. nexaIQ is decision-support software: AI output remains a candidate until a qualified person reviews it. It does not certify repairs, vehicle safety, OEM compliance, or payment.
